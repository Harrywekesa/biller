...
public abstract interface TransactionDao {
    ...
    @androidx.room.Query(value = "SELECT SUM(amount) FROM transactions WHERE isIncome = 0 AND (recipientName LIKE \'%\' || :personName || \'%\' OR recipientNumber LIKE \'%\' || :personName || \'%\') AND dateTimestamp BETWEEN :startDate AND :endDate AND (:simId IS NULL OR simSubscriptionId = :simId)")
    @org.jetbrains.annotations.NotNull()
    public abstract kotlinx.coroutines.flow.Flow<java.lang.Double> getSpentForPersonBetween(@org.jetbrains.annotations.NotNull()
    java.lang.String personName, long startDate, long endDate, @org.jetbrains.annotations.Nullable()
    java.lang.Integer simId);
    
    @androidx.room.Query(value = "SELECT SUM(amount) FROM transactions WHERE isIncome = 1 AND (recipientName LIKE \'%\' || :personName || \'%\' OR recipientNumber LIKE \'%\' || :personName || \'%\') AND dateTimestamp BETWEEN :startDate AND :endDate AND (:simId IS NULL OR simSubscriptionId = :simId)")
    @org.jetbrains.annotations.NotNull()
    public abstract kotlinx.coroutines.flow.Flow<java.lang.Double> getIncomeFromPersonBetween(@org.jetbrains.annotations.NotNull()
    java.lang.String personName, long startDate, long endDate, @org.jetbrains.annotations.Nullable()
    java.lang.Integer simId);
    
    @androidx.room.Query(value = "SELECT SUM(transactionCost) FROM transactions WHERE (recipientName LIKE \'%\' || :personName || \'%\' OR recipientNumber LIKE \'%\' || :personName || \'%\') AND dateTimestamp BETWEEN :startDate AND :endDate AND (:simId IS NULL OR simSubscriptionId = :simId)")
    @org.jetbrains.annotations.NotNull()
    public abstract kotlinx.coroutines.flow.Flow<java.lang.Double> getFeesForPersonBetween(@org.jetbrains.annotations.NotNull()
    java.lang.String personName, long startDate, long endDate, @org.jetbrains.annotations.Nullable()
    java.lang.Integer simId);
