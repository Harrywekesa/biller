  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(2) {
      ...
      public void createAllTables(@NonNull final SupportSQLiteDatabase db) {
        db.execSQL("CREATE TABLE IF NOT EXISTS `transactions` (`receiptNumber` TEXT NOT NULL, `type` TEXT NOT NULL, `amount` REAL NOT NULL, `transactionCost` REAL NOT NULL, `dateTimestamp` INTEGER NOT NULL, `recipientName` TEXT NOT NULL, `recipientNumber` TEXT, `balance` REAL, `categoryId` INTEGER, `isRecurring` INTEGER NOT NULL, `isIncome` INTEGER NOT NULL, `rawSmsBody` TEXT NOT NULL, PRIMARY KEY(`receiptNumber`))");
        ...
        db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, 'e04a94e6a4a74cbba201234018bb166c')");
      }
    ...
    }, "e04a94e6a4a74cbba201234018bb166c", "6ae836a56b779edc508abba8c02888ff");
