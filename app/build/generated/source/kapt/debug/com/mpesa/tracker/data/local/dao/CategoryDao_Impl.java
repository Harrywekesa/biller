...
public final class CategoryDao_Impl implements CategoryDao {
  ...
  public CategoryDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfCategoryEntity = new EntityInsertionAdapter<CategoryEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `categories` (`id`,`name`,`colorCode`,`iconName`) VALUES (nullif(?, 0),?,?,?)";
      }
      ...
      protected void bind(@NonNull final SupportSQLiteStatement statement,
        ...
        if (entity.getColorCode() == null) {
          ...
          statement.bindString(3, entity.getColorCode());
        }
      ...
      public List<CategoryEntity> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new CategoryEntity(_tmpId,_tmpName,_tmpColorCode,_tmpIconName);
            _result.add(_item);
          }
          return _result;
        } finally {
  ...
  public Object getCategoryByName(final String name,
      final Continuation<? super CategoryEntity> arg1) {
      ...
      public CategoryEntity call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            _result = new CategoryEntity(_tmpId,_tmpName,_tmpColorCode,_tmpIconName);
          } else {
            _result = null;
          }
          return _result;
